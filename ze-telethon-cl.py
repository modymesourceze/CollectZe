...
async def start(event):
    ...
    if sender.id == DEVELOPER_ID:
        ...
        await bot.send_message(chat, '''**~ مرحبا بكم في بوت التجميع الخاص بسورس زد إي 🔱💞\n\n~ تم تطوير هذا البوت بواسطة مودي الهيبه @elhyba 🔱💞\n\n~ تم صنع هذا البوت لمنع الاشخاص من الاحتيال عليكم و بيعه لكم و لاساعدكم علي تجميع النقاط 🔱💞\n\n~ قناة الملفات @up_uo 🔱💞\n\n~ قناة المطور @source_ze 🔱💞**''', buttons=buttons)
